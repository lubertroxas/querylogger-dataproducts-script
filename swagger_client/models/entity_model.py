...
class EntityModel(object):
    ...
    discriminator_value_class_map = {
            'TABLES'.lower(): 'TableEntityData',
            'SYSTEM_SESSION_PROPERTIES'.lower(): 'SingleKeyEntityData',
            'ROLES'.lower(): 'SingleKeyEntityData',
            'USERS'.lower(): 'SingleKeyEntityData',
            'FUNCTIONS'.lower(): 'FunctionEntityData',
            'PROCEDURES'.lower(): 'ProcedureEntityData',
            'CATALOG_SESSION_PROPERTIES'.lower(): 'CatalogKeyEntityData',
            'QUERIES'.lower(): 'GlobalEntityData',
            'AUDIT_LOGS'.lower(): 'GlobalEntityData',
            'DATA_PRODUCTS'.lower(): 'DataProductEntityData',
            'TABLE_PROPERTIES'.lower(): 'PropertyEntityData',
            'SCHEMA_PROPERTIES'.lower(): 'PropertyEntityData',
    }
    ...
    def category(self):
        ...
        TABLES, FUNCTIONS, etc.  # noqa: E501
